...
from atomai_app import losses_metrics
from atomai_app.nets import (init_cls_model, init_fcnn_model, init_imspec_model,
                             init_reg_model)
from atomai_app.utils import (array2list, average_weights, gpu_usage_map,
...
class BaseTrainer:
    ...
    >>> t = BaseTrainer()
    >>> # Set a model
    >>> t.set_model(atomai_stacked.nets.Unet(), nb_classes=1)
    >>> # Compile trainer
    >>> t.compile_trainer(
...
class SegTrainer(BaseTrainer):
    ...
    Args:
        model:
            ...
            See atomai_stacked.nets for more details. One can also pass a custom fully
